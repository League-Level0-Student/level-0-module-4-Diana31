...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			...
			int task = JOptionPane.showOptionDialog(null, "What do you want to do to make your pet happy? (eg: cuddle, food, water, groom, clean up poop )", "Happiness", 0, JOptionPane.INFORMATION_MESSAGE, null,
